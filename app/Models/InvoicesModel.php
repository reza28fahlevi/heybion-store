...
class InvoicesModel extends Model
{
    ...
    protected $allowedFields    = ['invoice_number', 'total_invoice', 'payment_method', 'payment_status', 'payment_proof', 'created_by', 'updated_by', 'deleted_by', 'is_deleted', 'user_id', 'receipt_number', 'delivery_service', 'cancel_reason'];
